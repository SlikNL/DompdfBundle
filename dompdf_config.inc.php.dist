...
define("DOMPDF_DIR", str_replace(DIRECTORY_SEPARATOR, '/', realpath(__DIR__.'/../vendor/slik/dompdf-bundle/Slik/DompdfBundle/DomPDF/')));
...
elseif( file_exists(DOMPDF_DIR . "/dompdf_config.custom.inc.php") ){
